...
export const INITIAL_QUIZZES: Quiz[] = [
  {
    ...
    participationToken: "aaaa-draft-token-0000",
    participantCount: 0,
    questionCount: 2,
    createdAt: past(72),
  },
  {
    ...
    accessCode: "DEMO42",
    participationToken: "bbbb-active-token-1111",
    participantCount: 3,
    questionCount: 3,
    createdAt: past(48),
    publishedAt: past(1),
  },
  {
    ...
    accessCode: undefined,
    participationToken: "cccc-ended-token-2222",
    participantCount: 5,
    questionCount: 3,
    createdAt: past(168),
    publishedAt: past(96),
...
const defaultSessionFields = { totalScore: 0, antiCheatEventCount: 0, antiCheatEvents: [] as import("@/api/types").AdminSessionEvent[], warnings: [] as import("@/api/types").AdminSessionEvent[] };

export const DEMO_SESSIONS: AdminSession[] = [
  { ...defaultSessionFields, id: "sess-active-1", quizId: DEMO_QUIZ_IDS.active, quizTitle: "Canlı Kodlama Sınavı", formData: { name: "Ahmet Yılmaz", studentId: "2021001", email: "ahmet@uni.edu" }, startedAt: past(0.5), endsAt: future(0.5), isActive: true, isLocked: false },
  { ...defaultSessionFields, id: "sess-active-2", quizId: DEMO_QUIZ_IDS.active, quizTitle: "Canlı Kodlama Sınavı", formData: { name: "Zeynep Kaya", studentId: "2021042" }, startedAt: past(0.4), endsAt: future(0.6), isActive: true, isLocked: false },
  { ...defaultSessionFields, id: "sess-active-3", quizId: DEMO_QUIZ_IDS.active, quizTitle: "Canlı Kodlama Sınavı", formData: { name: "Mehmet Demir", studentId: "2020098", email: "" }, startedAt: past(0.3), endsAt: future(0.7), isActive: true, isLocked: true },
  { ...defaultSessionFields, id: "sess-ended-1", quizId: DEMO_QUIZ_IDS.ended, quizTitle: "Veri Yapıları Finali", formData: { name: "Elif Şahin", dept: "Bilgisayar Mühendisliği" }, startedAt: past(95), endsAt: past(93.5), finishedAt: past(93.8), isActive: false, isLocked: false, totalScore: 70 },
  { ...defaultSessionFields, id: "sess-ended-2", quizId: DEMO_QUIZ_IDS.ended, quizTitle: "Veri Yapıları Finali", formData: { name: "Burak Arslan", dept: "Yazılım Mühendisliği" }, startedAt: past(95), endsAt: past(93.5), finishedAt: past(94), isActive: false, isLocked: false, totalScore: 60 },
  { ...defaultSessionFields, id: "sess-ended-3", quizId: DEMO_QUIZ_IDS.ended, quizTitle: "Veri Yapıları Finali", formData: { name: "Selin Öztürk", dept: "Bilgisayar Mühendisliği" }, startedAt: past(95), endsAt: past(93.5), finishedAt: past(93.6), isActive: false, isLocked: false, totalScore: 50 },
  { ...defaultSessionFields, id: "sess-ended-4", quizId: DEMO_QUIZ_IDS.ended, quizTitle: "Veri Yapıları Finali", formData: { name: "Tolga Aydın", dept: "Elektrik-Elektronik" }, startedAt: past(95), endsAt: past(93.5), finishedAt: past(94.2), isActive: false, isLocked: false, totalScore: 30 },
  { ...defaultSessionFields, id: "sess-ended-5", quizId: DEMO_QUIZ_IDS.ended, quizTitle: "Veri Yapıları Finali", formData: { name: "Ayşe Çelik", dept: "Bilgisayar Mühendisliği" }, startedAt: past(95), endsAt: past(93.5), finishedAt: past(93.7), isActive: false, isLocked: false, totalScore: 50 },
];
